...
<!--###HTML_PREP_END###-->
			...
			<tr>
				...
				<td>
							...
							<span id="beta_firmware_path_span"><input type="checkbox" id="beta_firmware_path" name="beta_firmware_path" id="beta_firmware_path" onclick="change_firmware_path(this.checked==true);"  <% nvram_match("firmware_path", "1", "checked"); %>>Get Beta Firmware</input></span>
