...
#define QUAGGA_CONFIG_ARGS "--host=arm-linux --build= --disable-ripngd --disable-ospfd --disable-doc --disable-ospfclient --disable-ospf6d --disable-bgpd --disable-bgp-announce --disable-babeld --disable-isisd"
