...
//		nvram_set_int("led_2g_gpio", 72|GPIO_ACTIVE_LOW);
	...
	case MODEL_RTAC1200GP:
		...
		nvram_set_int("led_pwr_gpio", 15);    // |GPIO_ACTIVE_HIGH
		nvram_set_int("led_wps_gpio", 10);    // |GPIO_ACTIVE_HIGH
		nvram_set_int("led_5g_gpio", 11);     // |GPIO_ACTIVE_HIGH
		nvram_set_int("led_usb_gpio", 1);     // |GPIO_ACTIVE_HIGH
