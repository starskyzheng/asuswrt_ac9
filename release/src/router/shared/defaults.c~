...
#endif
	{ "wl_ssid", "114", 0 },		/* Service set ID (network name) */
...
//	{ "wl_mimo_preamble", "gfbcm", 0 },	/* Mimo PrEamble: mm/gf/auto/gfbcm */
	...
	{ "wl_wpa_psk", "nidieshi116", 0 },		/* WPA pre-shared key */
...
#endif
#else
	{ "wl_bw", "1", 0 },		/* 0/1/2 20, 20/40, 40MHz */
#endif
...
// Wireless Mac Filter
	...
	{ "bsd_helper", "192.168.0.2", 0 },	/* BSD primary ipaddr */
	{ "bsd_primary", "192.168.0.1", 0 },	/* BSD Helper ipaddr */
...
/*	{ "http_lanport", "80" }, */
	...
	{ "vpn_server_dhcp",		"1"		},
	{ "vpn_server_r1",		"192.168.0.50"	},
	{ "vpn_server_r2",		"192.168.0.55"	},
